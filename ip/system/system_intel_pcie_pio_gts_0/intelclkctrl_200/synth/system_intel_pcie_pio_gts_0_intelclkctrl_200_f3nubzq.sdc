...
source "$script_dir/system_intel_pcie_pio_gts_0_intelclkctrl_200_f3nubzq_parameters.tcl"
...
proc warn_skipped_instances { skipped_instances } {
        ...
        foreach clock_div_inst $skipped_instances {
                ...
                for {set outclk 0} {$outclk < $::GLOBAL_system_intel_pcie_pio_gts_0_intelclkctrl_200_f3nubzq_out_clocks} {incr outclk} {
...
proc get_clock_divider_instances {} {
        ...
        set core $::GLOBAL_system_intel_pcie_pio_gts_0_intelclkctrl_200_f3nubzq_core
...
foreach inst [get_clock_divider_instances] {
        ...
        set num_clock_fanins [ dict size $clock_fanins ]
        if { $num_clock_fanins < $::GLOBAL_system_intel_pcie_pio_gts_0_intelclkctrl_200_f3nubzq_in_clocks } {
                warn_missing_clock_sources $clkdiv_inclk $::GLOBAL_system_intel_pcie_pio_gts_0_intelclkctrl_200_f3nubzq_in_clocks clock_fanins other_fanins
        }        
