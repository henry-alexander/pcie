// system_intel_pcie_gts_0_one_lane_pcie_hal_pldif_hal_2100_52q5uwa.v

// Generated using ACDS version 23.4.1 205

`timescale 1 ps / 1 ps
module system_intel_pcie_gts_0_one_lane_pcie_hal_pldif_hal_2100_52q5uwa #(
		...
		parameter       ch_pldif_l_tx_bond_location_atom         = "TX_BOND_LOCATION_MIDDLE",
	...
	generate
		...
		if (ch_pldif_l_tx_bond_location_atom != "TX_BOND_LOCATION_MIDDLE")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	system_intel_pcie_gts_0_pldif_hal_2100_7x7kbai #(
		...
		.ch_pldif_l_tx_bond_location_atom         ("TX_BOND_LOCATION_MIDDLE"),
