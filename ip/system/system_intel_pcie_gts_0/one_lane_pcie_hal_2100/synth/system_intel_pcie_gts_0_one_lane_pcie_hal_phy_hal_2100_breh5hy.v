// system_intel_pcie_gts_0_one_lane_pcie_hal_phy_hal_2100_breh5hy.v

// Generated using ACDS version 23.4.1 205

`timescale 1 ps / 1 ps
module system_intel_pcie_gts_0_one_lane_pcie_hal_phy_hal_2100_breh5hy #(
		...
		parameter[3:0]  ch_l_xcvr_rx_prbs_pattern_atom                     = 4'b1100,
		...
		parameter[7:0]  ch_l_tx_postdiv_clk_divider_atom                   = 8'b01001001,
		...
		parameter[7:0]  ch_l_tx_pll_feed_forward_gain_atom                 = 8'b10111110,
		...
		parameter[35:0] ch_l_ick_tx_word_clk_hz_atom                       = 36'b001100101001001000100111001010100001,
		parameter[35:0] ch_l_pcs_ref_clk_hz_atom                           = 36'b101100010000010101001001000100001000,
		parameter[35:0] ch_l_lane_common_ref_clk_hz_atom                   = 36'b101110010000101000000100000110110110,
		parameter       ch_rx_invert_pin_atom                              = "RX_INVERT_PIN_ENABLE",
		parameter       ch_tx_invert_pin_atom                              = "TX_INVERT_PIN_ENABLE",
		parameter[17:0] ch_rx_dl_rx_lat_bit_for_async_atom                 = 18'b111010100000111101,
		parameter       ch_rx_dl_rxbit_cntr_pma_atom                       = "RX_DL_RXBIT_CNTR_PMA_DISABLE",
		parameter[17:0] ch_rx_dl_rxbit_rollover_atom                       = 18'b111000111110011110,
	...
	generate
		...
		if (ch_l_xcvr_rx_prbs_pattern_atom != 4'b1100)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_tx_postdiv_clk_divider_atom != 8'b01001001)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_tx_pll_feed_forward_gain_atom != 8'b10111110)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_ick_tx_word_clk_hz_atom != 36'b001100101001001000100111001010100001)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_pcs_ref_clk_hz_atom != 36'b101100010000010101001001000100001000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_lane_common_ref_clk_hz_atom != 36'b101110010000101000000100000110110110)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_tx_invert_pin_atom != "TX_INVERT_PIN_ENABLE")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_rx_dl_rx_lat_bit_for_async_atom != 18'b111010100000111101)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_rx_dl_rxbit_rollover_atom != 18'b111000111110011110)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	system_intel_pcie_gts_0_phy_hal_2100_vyl5wia #(
		...
		.ch_l_xcvr_rx_prbs_pattern_atom                     (4'b1100),
		...
		.ch_l_tx_postdiv_clk_divider_atom                   (8'b01001001),
		...
		.ch_l_tx_pll_feed_forward_gain_atom                 (8'b10111110),
		...
		.ch_l_ick_tx_word_clk_hz_atom                       (36'b001100101001001000100111001010100001),
		.ch_l_pcs_ref_clk_hz_atom                           (36'b101100010000010101001001000100001000),
		.ch_l_lane_common_ref_clk_hz_atom                   (36'b101110010000101000000100000110110110),
		.ch_rx_invert_pin_atom                              ("RX_INVERT_PIN_ENABLE"),
		.ch_tx_invert_pin_atom                              ("TX_INVERT_PIN_ENABLE"),
		.ch_rx_dl_rx_lat_bit_for_async_atom                 (18'b111010100000111101),
		.ch_rx_dl_rxbit_cntr_pma_atom                       ("RX_DL_RXBIT_CNTR_PMA_DISABLE"),
		.ch_rx_dl_rxbit_rollover_atom                       (18'b111000111110011110),
