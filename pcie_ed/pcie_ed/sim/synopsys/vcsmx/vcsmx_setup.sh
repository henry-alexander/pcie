...
TOP_LEVEL_NAME="pcie_ed.pcie_ed"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/nfs/site/disks/swbld_archive_4/acds/23.4.1/205/linux64/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [pcie_ed::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [pcie_ed::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [pcie_ed::get_design_libraries]]
...
mkdir -p ./libraries/tennm_hvio/
mkdir -p ./libraries/tennm_agilex5_io96/
mkdir -p ./libraries/tennm/
mkdir -p ./libraries/tennm_agilex5_hssi_a/
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio.sv"                  -work tennm_hvio              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio_ncrypt.sv"           -work tennm_hvio              
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96.sv"          -work tennm_agilex5_io96      
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96_ncrypt.sv"   -work tennm_agilex5_io96      
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a.sv"        -work tennm_agilex5_hssi_a    
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a_ncrypt.sv" -work tennm_agilex5_hssi_a    
fi
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [pcie_ed::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [pcie_ed::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
