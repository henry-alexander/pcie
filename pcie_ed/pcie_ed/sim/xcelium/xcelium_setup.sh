...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio.sv"                  -work tennm_hvio          
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio_ncrypt.sv"           -work tennm_hvio          
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96.sv"          -work tennm_agilex5_io96  
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96_ncrypt.sv"   -work tennm_agilex5_io96  
  ...
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a.sv"        -work tennm_agilex5_hssi_a
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a_ncrypt.sv" -work tennm_agilex5_hssi_a
fi
