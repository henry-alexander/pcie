...
# ----------------------------------------
# If pcie_ed is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.4.1 205 linux 2024.03.20.07:24:45
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pcie_ed.pcie_ed"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/nfs/site/disks/swbld_archive_4/acds/23.4.1/205/linux64/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [pcie_ed::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [pcie_ed::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [pcie_ed::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [pcie_ed::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [pcie_ed::normalize_path "$file"]
  set normalized_dest [pcie_ed::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_hvio_ver" "tennm_agilex5_io96_ver" "tennm_sm_ver" "tennm_agilex5_hssi_a_ver" "altera" "lpm" "sgate" "altera_mf" "altera_lnsim" "tennm_hvio" "tennm_agilex5_io96" "tennm" "tennm_agilex5_hssi_a"]
...
set libraries [dict merge $libraries [pcie_ed::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [pcie_ed::get_design_libraries]]
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    ...
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                           "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio.sv"                  -work tennm_hvio              
    eval  vlog -sv -suppress 2583 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS            "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio_ncrypt.sv"           -work tennm_hvio              
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                           "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96.sv"          -work tennm_agilex5_io96      
    eval  vlog -sv -suppress 2583,13314 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96_ncrypt.sv"   -work tennm_agilex5_io96      
    ...
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                           "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a.sv"        -work tennm_agilex5_hssi_a    
    eval  vlog -sv -suppress 7061,2583,13314 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a_ncrypt.sv" -work tennm_agilex5_hssi_a    
  }
...
alias com {
  ...
  set design_files [dict merge [pcie_ed::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [pcie_ed::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
