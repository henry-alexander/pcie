...
alias dev_com {
  ...
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio.sv"                  -work tennm_hvio              
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_hvio_ncrypt.sv"           -work tennm_hvio              
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96.sv"          -work tennm_agilex5_io96      
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                  "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_io96_ncrypt.sv"   -work tennm_agilex5_io96      
  ...
  eval                    vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a.sv"        -work tennm_agilex5_hssi_a    
  eval                    vlog  -err VCP2675 W1 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                  "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex5_hssi_a_ncrypt.sv" -work tennm_agilex5_hssi_a    
}
