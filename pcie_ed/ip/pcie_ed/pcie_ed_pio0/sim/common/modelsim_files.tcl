...
namespace eval pcie_ed_pio0 {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intelclkctrl_200/sim/pcie_ed_pio0_intelclkctrl_200_f3nubzq.v"]\"  -work intelclkctrl_200"                                            
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_pcie_pio_gts_234/sim/pcie_ed_pio0_intel_pcie_pio_gts_intelclkctrl_234_dwo3zja.v"]\"  -work intel_pcie_pio_gts_234"             
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_pcie_pio_gts_234/sim/intel_pcie_bam_hwtcl_pcie_ed_pio0_intel_pcie_pio_gts_234_bnb5jay.sv"]\"  -work intel_pcie_pio_gts_234"
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_pcie_pio_gts_234/sim/mentor/intel_pcie_bam_pipeline.sv"]\"  -work intel_pcie_pio_gts_234"                                  
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_pcie_pio_gts_234/sim/mentor/intel_pcie_bam_avmm_intf_pipeline.sv"]\"  -work intel_pcie_pio_gts_234"                        
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_pcie_pio_gts_234/sim/mentor/intel_pcie_bam_cpl_pipeline.sv"]\"  -work intel_pcie_pio_gts_234"                              
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../intel_pcie_pio_gts_234/sim/mentor/intel_pcie_bam_sch_intf_pipeline.sv"]\"  -work intel_pcie_pio_gts_234"                         
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/pcie_ed_pio0.v"]\"  -work pcie_ed_pio0"                                                                                                 
    return $design_files
  }
