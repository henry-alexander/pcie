...
# ----------------------------------------
# If pcie_ed_resetIP is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.4.1 205 linux 2024.03.20.07:24:43
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pcie_ed_resetIP.pcie_ed_resetIP"
}
...
append ELAB_OPTIONS [subst [pcie_ed_resetIP::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [pcie_ed_resetIP::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [pcie_ed_resetIP::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [pcie_ed_resetIP::normalize_path "$file"]
  set normalized_dest [pcie_ed_resetIP::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [pcie_ed_resetIP::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [pcie_ed_resetIP::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [pcie_ed_resetIP::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [pcie_ed_resetIP::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
