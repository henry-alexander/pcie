...
# ----------------------------------------
# ACDS 23.4.1 205 win32 2024.03.21.07:49:21
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/intelfpga_pro/23.4.1/quartus/"
}
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [system::get_memory_files "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set design_files [concat $design_files [system::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
