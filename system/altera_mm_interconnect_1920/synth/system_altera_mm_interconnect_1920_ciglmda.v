// system_altera_mm_interconnect_1920_ciglmda.v
...
`timescale 1 ps / 1 ps
module system_altera_mm_interconnect_1920_ciglmda (
	...
	system_altera_merlin_master_translator_192_lykd4la #(
		.AV_ADDRESS_W                (64),
		.AV_DATA_W                   (512),
		.AV_BURSTCOUNT_W             (4),
		.AV_BYTEENABLE_W             (64),
	...
	system_altera_merlin_slave_translator_191_x56fcki #(
		.AV_ADDRESS_W                   (8),
		.AV_DATA_W                      (512),
		.UAV_DATA_W                     (512),
		.AV_BURSTCOUNT_W                (1),
	...
	system_altera_merlin_master_agent_1921_2inlndi #(
		.PKT_WUNIQUE               (689),
		.PKT_DOMAIN_H              (688),
		.PKT_DOMAIN_L              (687),
		.PKT_SNOOP_H               (686),
	...
	system_altera_merlin_slave_agent_1921_b6r3djy #(
		.PKT_ORI_BURST_SIZE_H      (680),
		.PKT_ORI_BURST_SIZE_L      (678),
		.PKT_RESPONSE_STATUS_H     (677),
		.PKT_RESPONSE_STATUS_L     (676),
	...
	system_altera_avalon_sc_fifo_1931_vhmcgqy #(
		.SYMBOLS_PER_BEAT    (1),
		.BITS_PER_SYMBOL     (704),
		.FIFO_DEPTH          (3),
		.CHANNEL_WIDTH       (0),
	...
	system_altera_merlin_router_1921_3x2ld6i router (
	...
	system_altera_merlin_router_1921_xl25uli router_001 (
	...
	system_altera_merlin_burst_adapter_1931_isablti #(
		.PKT_ADDR_H                (639),
		.PKT_ADDR_L                (576),
		.PKT_BEGIN_BURST           (664),
		.PKT_BYTE_CNT_H            (655),
	...
	system_altera_merlin_demultiplexer_1921_4qvfzsi cmd_demux (
		.clk                (pio0_pio_master_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset              (pio0_pio_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_altera_merlin_multiplexer_1922_5zre3aq cmd_mux (
		.clk                 (pio0_pio_master_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset               (pio0_pio_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_altera_merlin_demultiplexer_1921_4qvfzsi rsp_demux (
		.clk                (pio0_pio_master_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset              (pio0_pio_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_altera_merlin_multiplexer_1922_4t7siiq rsp_mux (
		.clk                 (pio0_pio_master_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset               (pio0_pio_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
