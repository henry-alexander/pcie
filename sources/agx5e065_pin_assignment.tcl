...
###### I am putting the FPGA Fabric Clock outside so we always have access to it
...
if {$wHDMI == 1} {
# Why is the FPGA Fabric clock locked under the wHDMI, shouldn't this just be an always included?
set_location_assignment PIN_AC68  -to REFCLK_3B0_p -comment IOBANK_3B_B
set_instance_assignment -name IO_STANDARD "1.2V True Differential Signaling" -to REFCLK_3B0_p
...
set_location_assignment PIN_AY133  -to PET_p[2]
